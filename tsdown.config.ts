...
const PLUGIN_ID = 'dsh-missher-evolution'
const CSS_PREFIX = '\0mse-css:'
...
function cssModulesInlinePlugin() {
  ...
  return {
    ...
    async load(id: string) {
      ...
      if (file === undefined) throw new Error('mse css module was not resolved')
